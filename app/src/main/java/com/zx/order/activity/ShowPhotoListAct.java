...
import com.zx.order.custom.CustomViewPage;
 ...
 * Q Q: 1320666709
 */
public class ShowPhotoListAct extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    private class PhotosAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View view = LayoutInflater.from(ShowPhotoListAct.this).inflate(R.layout.layout_show_photos, null);
            ...
            Glide.with(ShowPhotoListAct.this)

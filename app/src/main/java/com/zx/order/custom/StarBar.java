...
public class StarBar extends View {
    ...
    private int starSize = DensityUtil.dip2px(25);     //星星高度大小，星星一般正方形，宽度等于高度
    ...
    private void init(Context context) {
        setClickable(true);
        TypedArray mTypedArray = context.obtainStyledAttributes(R.styleable.RatingBar);
        ...
        this.starEmptyDrawable = ContextCompat.getDrawable(context, R.drawable.rating_un_select);
        this.starFillBitmap = drawableToBitmap(ContextCompat.getDrawable(context, R.drawable.rating_select));
        mTypedArray.recycle();
